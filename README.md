...
- [NMOS resistive region and Saturation region of operation](#nmos-resistive-region-and-saturation-region-of-operation)
   ...
   - [L6 Drain current model for saturation region of opertion](#l6-drain-current-model-for-saturation-region-of-opertion)
 ...
 - [CMOS voltage transer Characteristics(VTC)](#cmos-voltage-transer-characteristicsvtc)
   ...
   - [Lecture 6 Step 4 — Merging Load Curves and Building the VTC](#lecture-6-step-4--merging-load-curves-and-building-the-vtc)
- [NgspiceSky130-Day3-CMOS switching threshold and dynamic simulations](#ngspicesky130-day3-cmos-switching-threshold-and-dynamic-simulations)
 ...
 - [DAY 3.2.1 Static behaviour evaluation-CMOS inverter robustness-Switching Threshold](#day-321-static-behaviour-evaluation-cmos-inverter-robustness-switching-threshold)
   - [L1 Switching Threshold,Vm](#l1-switching-thresholdvm)
...
- [NgspiceSky130-Day4-CMOS Noise Margin robustness evaluation](#ngspicesky130-day4-cmos-noise-margin-robustness-evaluation)
   - [DAY 4.1 L1 Introduction to Noise Margin](#day-41-l1-introduction-to-noise-margin)
   - [4.2 L2 Noise Margin voltage paramters](#42-l2-noise-margin-voltage-paramters)
   - [L3 Noise margin equation and summary](#l3-noise-margin-equation-and-summary)
   - [4.4 L4 Noise margin variation with respect to PMOS width](#44-l4-noise-margin-variation-with-respect-to-pmos-width)
   - [L5 Sky130 Noise margin labs](#l5-sky130-noise-margin-labs)
- [5.1 NgspiceSky130-Day5-CMOS power supply and device variation robustness evaluation](#51-ngspicesky130-day5-cmos-power-supply-and-device-variation-robustness-evaluation)
  ...
  - [5.2 Static behaviour evaluation-CMOS inverter robustness-Power supply variation](#52-static-behaviour-evaluation-cmos-inverter-robustness-power-supply-variation)
